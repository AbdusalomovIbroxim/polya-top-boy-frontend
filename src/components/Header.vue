<template>
  <div class="flex items-center bg-white p-6 pb-2 justify-between">
    <h2 class="text-[#131711] text-lg font-bold leading-tight tracking-[-0.015em] flex-1 text-center">Football Field</h2>
